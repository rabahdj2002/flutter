...
final parametersBuilderMap =
  ...
  'noteDetails': (data) async => ParameterData(
        allParams: {
  ...
  'selectLocation': ParameterData.none(),
  ...
  'OverdueTasks': (data) async => ParameterData(
        allParams: {
          'tabIndex': getParameter<int>(data, 'tabIndex'),
        },
      ),
  'CompletedTasks': (data) async => ParameterData(
        allParams: {
          'tabIndex': getParameter<int>(data, 'tabIndex'),
        },
      ),
  'AllTasks': (data) async => ParameterData(
        allParams: {
          'tabIndex': getParameter<int>(data, 'tabIndex'),
        },
      ),
