...
class _PendingTasksWidgetState extends State<PendingTasksWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PendingTasksModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> pendingTasksUsersRecordList = snapshot.data!;
                            ...
                            tabs: [
                              Tab(
                                text: FFLocalizations.of(context).getText(
                                  '60z7oney' /* Assigned Tasks */,
                                ),
                              ),
                              Tab(
                                text: FFLocalizations.of(context).getText(
                                  'c9utge04' /* Created Tasks */,
                                ),
                              ),
                            ],
                                    ...
                                    children: [
                                                ...
                                                return Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    child: TaskComponentWidget(
                                                      key: Key(
                                                          'Keyx95_${listViewIndex}_of_${listViewNotesRecordList.length}'),
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '98w6m4lt' /* Made By: Eng. Bandar Majeed */,
                                            ),
                                  ...
                                  children: [
                                            ...
                                            itemBuilder:
                                              ...
                                              return Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: TaskComponentWidget(
                                                    key: Key(
                                                        'Keyikh_${listViewIndex}_of_${listViewNotesRecordList.length}'),
                                                    note: listViewNotesRecord,
                                                  ),
                                                ),
                                              );
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'tk0zpp49' /* Made By: Eng. Bandar Majeed */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
