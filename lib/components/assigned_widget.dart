...
class _AssignedWidgetState extends State<AssignedWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssignedModel());
  }
      ...
      children: [
        ...
        Align(
          ...
          child: Padding(
            ...
            child: Text(
              FFLocalizations.of(context).getText(
                'qabk13vg' /* How many tasks are currently p... */,
              ),
