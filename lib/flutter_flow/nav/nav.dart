...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          requireAuth: true,
          asyncParams: {
            'note': getDoc(['notes'], NotesRecord.fromSnapshot),
          },
          builder: (context, params) => NoteDetailsWidget(
        ...
        FFRoute(
          name: 'OverdueTasks',
          path: '/overdueTasks',
          builder: (context, params) => OverdueTasksWidget(
            tabIndex: params.getParam(
              'tabIndex',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: 'CompletedTasks',
          path: '/completedTasks',
          builder: (context, params) => CompletedTasksWidget(
            tabIndex: params.getParam(
              'tabIndex',
              ParamType.int,
            ),
