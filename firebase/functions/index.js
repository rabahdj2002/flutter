...
const kUserKey = "ZDIyMWYzOWQtMDRmMC00MjY1LWExNDQtNmE2MTQxNzE1MzM5";
const kAPIKey = "YzdiMGQ5MjQtMmFkNi00MWQ0LWEzZTEtMjdhMTY0OWY3ZDk5";
...
exports.addUser = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    const createdUser = await client.createUser(
      "fe5f6d8b-3382-4b00-81d0-d7caa3c6d0ff",
      user,
    );
